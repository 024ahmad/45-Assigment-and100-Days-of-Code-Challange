...
let transport : string [] = ["land cruiser","lamborgini","kawasaki ninja H2r"];
...
let guestArr1 : string [] = ["Furqan","Hamid","Farhan"];
...
let guestArr : string [] = ["Meelad","Hamid","Furqan","Farhan"];
let canNotAttend : string = "Furqan";
let newGuest : string = "Ajmal";
