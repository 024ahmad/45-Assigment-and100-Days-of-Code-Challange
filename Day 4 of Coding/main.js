...
// Solution:
// Autor: [Ahmad Raza]
// Date: [Sunday, Febuarary 18, 2024]
// // My favorite Number in a Variable:
// let favoriteNum : number = 7;
// // My Message using console.log Method
...
// Solution:
var names = ["Hamid", "Furqan", "Ajmal", "Abdul Rehman", "Farhan"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
// Solution:
// let names = ["Hamid","Furqan","Ajmal","Abdul Rehman","Farhan"];
var message2 = "You are my friend";
...
console.log("".concat(names[4], " ").concat(message2));
